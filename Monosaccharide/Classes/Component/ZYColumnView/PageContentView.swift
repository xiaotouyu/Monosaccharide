...
extension PageContentView : UICollectionViewDelegate{
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        print("PageContentView-----scrollViewDidScroll: \(targetIndex) childVcs.count: \(childVcs.count)")
        //MARK:- 定义代理3
...
extension PageContentView {
    ...
    public func reloadChildVcs(newChildVcs: [UIViewController]) {
        ...
        print("PageContentView----reloadChildVcs--self.self.childVcs\(self.childVcs)    \n self.childVcs.count: \(self.childVcs.count)  newChildVcs: \(newChildVcs.count) defaultVcsCount: \(defaultVcsCount)")
